...
* delete draft release+tag on failure for all triggers; publish as latest on success ([cb831b7](https://github.com/Akylas/gps-mocker-rs/commit/cb831b72cd436db642d8921fec0a73a6865becde))
...
* undo version bump commit and tag when builds fail ([4ca97d5](https://github.com/Akylas/gps-mocker-rs/commit/4ca97d5b306e8009a9b07f7d6963f1467606f55c))
