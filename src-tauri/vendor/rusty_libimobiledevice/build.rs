...
fn main() {
    ...
    if cfg!(feature = "vendored") {
        ...
        repo_setup("https://github.com/libimobiledevice/libplist.git", None);
        repo_setup(
            "https://github.com/libimobiledevice/libimobiledevice-glue.git",
            None,
        );
        repo_setup("https://github.com/libimobiledevice/libusbmuxd.git", None);
        // Pinned to the last commit before libimobiledevice took a hard dependency on
        // libtatsu (68df374, 2024-06-27), which is not part of this vendored chain.
        repo_setup(
            "https://github.com/libimobiledevice/libimobiledevice.git",
            Some("ed0d66d0341562731bb19928dfe48155509fa7a7"),
        );
...
fn repo_setup(url: &str, commit: Option<&str>) {
