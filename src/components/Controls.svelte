  ...
  {#each layout as item}
    {#if item === 'playpause'}
      <div class="btn" on:click={togglePlay} class:active={isPlaying || isPaused}>
        {#if isPlaying}
          <svg {...ICON_SIZE}>
            <rect height="22.9" rx="1.9" width="7.6" x="14" y=".5" />
            <rect height="22.9" rx="1.9" width="7.6" x="2" y=".5" />
          </svg>
        {:else}
          <svg {...ICON_SIZE}>
            <path
          ...
          <div class="btn" slot="target">
            <svg {...ICON_SIZE}>
              <path
                ...
                fill-rule="evenodd"
              />
              <path d="M12.229 7.945l-2.07 4.598-2.586-2.605-2.414 2.758v2.146h9.656V11.93z" />
              <circle cx="7.444" cy="6.513" r="2.032" />
              <path
      ...
      <div class="btn" on:click={onNextFrame}>
        <svg {...ICON_SIZE}>
          ...
          <rect
            height="17.143"
            rx="1.429"
            transform="matrix(1 0 0 -1 16.286 20.571)"
            width="5.714"
          />
        </svg>
      </div>
    {:else if item === 'previousFrame'}
      <div class="btn" on:click={oPreviousFrame}>
        <svg {...ICON_SIZE}>
          <path
            d="M22 4.5a1.4 1.4 0 00-2.1-1.2l-13 7.5a1.4 1.4 0 000 2.4l13 7.5a1.4 1.4 0 002.1-1.2z"
          />
          <rect height="17.1" rx="1.4" transform="matrix(-1 0 0 1 7.7 3.4)" width="5.7" />
        </svg>
      </div>
    {:else if item === 'spacer'}
      <div class="spacer" />
